 ...
 * @file com.secoder.base.AnnotationReflectionClassStruct
 * @author sf
...
public static void main(String[] args) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException {
	...
	Class c1 = Class.forName("com.java.com.secoder.base.com.secoder.base.ClassRunStruct");
...
public String toString() {
	return "com.secoder.base.ClassRunStruct{" +
			       "name='" + name + '\'' +
			       ", id=" + id +
			       ", age=" + age +
			       '}';
