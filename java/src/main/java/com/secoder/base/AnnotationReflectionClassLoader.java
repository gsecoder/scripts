...
/**
 * @file com.secoder.base.AnnotationReflectionClassLoader
 * @author sf
...
public static void main(String[] args) throws ClassNotFoundException {
	...
	// 4、测试当前类是那个加载器加载的
	ClassLoader classLoader = Class.forName("com.java.com.secoder.base.com.secoder.base.AnnotationReflectionClassLoader").getClassLoader();
