package base; /**
 * @file base.AnnotationReflectionClassUse
 * @author sf
...
public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchFieldException {
	...
	// 获取 Class 对象
	Class c1 = Class.forName("com.java.base.base.TempAnnotationReflectionClassUse");
...
public String toString() {
	return "base.TempAnnotationReflectionClassUse{" +
			       "id=" + id +
			       ", name='" + name + '\'' +
			       ", age=" + age +
			       '}';
